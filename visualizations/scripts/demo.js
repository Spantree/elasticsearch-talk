...
(function() {
  var Aggregation, DateHistogramAggregation, HistogramAggregation, TermsAggregation, buildAggregationBody, flattenAggregationResponse,
  ...
  Aggregation = (function() {
    ...
    function Aggregation(opts) {
      ...
      if (opts.reduceSumFunction) {
        this.reduceSumFunction = opts.reduceSumFunction;
      }
      if (opts.chartPostSetup) {
        this.chartPostSetup = opts.chartPostSetup;
      }
    }
  ...
  DateHistogramAggregation = (function(_super) {
    ...
    function DateHistogramAggregation(opts) {
      ...
      this.interval = opts.interval || 'day';
    }
  ...
  flattenAggregationResponse = function(aggregations, results, parentData) {
  ...
  window.myController = function($scope) {
    var ageAgg, aggregationBody, aggregations, dateAgg, durationAgg, es, genderAgg;
